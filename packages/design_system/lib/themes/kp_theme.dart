...
abstract final class KpTheme {
  ...
  static const ColorScheme _lightScheme = ColorScheme(
    ...
    tertiary: KpColors.tertiary500,
    onTertiary: KpColors.neutral0,
    tertiaryContainer: KpColors.tertiary300,
    onTertiaryContainer: KpColors.tertiary600,
  ...
  static const ColorScheme _darkScheme = ColorScheme(
    ...
    tertiary: KpColors.tertiary300,
    onTertiary: KpColors.neutral900,
    tertiaryContainer: Color(0xFF5A0010),
    onTertiaryContainer: KpColors.tertiary100,
    error: KpColors.error500,
    onError: KpColors.neutral0,
