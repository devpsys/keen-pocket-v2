/// Public surface of the `group_collaboration` feature — group chat (and later
/// disputes), attached to a pocket/adashi. Presentation only; built dark.
library;

export 'presentation/pages/disputes_hub_page.dart';
