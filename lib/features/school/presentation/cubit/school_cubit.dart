...
/// PRESENTATION-ONLY: placeholder school summary; backend-gap, so the page is
/// also flag-gated (built dark). Swap for a use case when the API exists.
@injectable
  ...
  Future<void> load() async {
    ...
    emit(
      state.copyWith(
        ...
        school: const SchoolView(
          name: 'Bright Future Academy',
          classCount: 9,
          studentCount: 214,
          feesCollected: Money(450000000),
        ),
      ),
    );
  }
