...
/// Dev-only stub so the inbox renders without a backend. Mirrors the old
/// presentation fixtures. `prod`/`staging` use [NotificationsRepositoryImpl].
@LazySingleton(as: NotificationsRepository, env: ['dev'])
class FakeNotificationsRepository implements NotificationsRepository {
  const FakeNotificationsRepository();

  static const _pocketImage =
  ...
  static const _items = <AppNotification>[
    AppNotification(
      id: 'n1',
      ...
      relatedPocketImageUrl: _pocketImage,
